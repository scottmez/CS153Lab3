...
int shm_open(int id, char **pointer) {
80106cf6:	56                   	push   %esi
80106cf7:	53                   	push   %ebx
...
80106d24:	eb 1b                	jmp    80106d41 <shm_open+0x51>
...
80106d2a:	75 0d                	jne    80106d39 <shm_open+0x49>
80106d2c:	85 c9                	test   %ecx,%ecx
80106d2e:	66 90                	xchg   %ax,%ax
80106d30:	75 02                	jne    80106d34 <shm_open+0x44>
80106d32:	89 c7                	mov    %eax,%edi
      //stores first index
      first_index = i;
      //sets flag to use first index instead
      first_found = 1;
80106d34:	b9 01 00 00 00       	mov    $0x1,%ecx
  for (i = 0; i< 64; i++) {
80106d39:	83 c0 01             	add    $0x1,%eax
80106d3c:	83 f8 40             	cmp    $0x40,%eax
80106d3f:	74 7f                	je     80106dc0 <shm_open+0xd0>
80106d41:	8d 14 40             	lea    (%eax,%eax,2),%edx
80106d44:	8d 1c 95 00 00 00 00 	lea    0x0(,%edx,4),%ebx
    if(shm_table.shm_pages[i].id == id){
80106d4b:	8b 14 95 f4 54 11 80 	mov    -0x7feeab0c(,%edx,4),%edx
80106d52:	39 f2                	cmp    %esi,%edx
80106d54:	75 d2                	jne    80106d28 <shm_open+0x38>
      mappages(myproc()->pgdir,(char*)address_v , PGSIZE, V2P(shm_table.shm_pages[i].frame) , PTE_W|PTE_U);
80106d56:	8b 83 f8 54 11 80    	mov    -0x7feeab08(%ebx),%eax
80106d5c:	8d b0 00 00 00 80    	lea    -0x80000000(%eax),%esi
80106d62:	e8 49 c9 ff ff       	call   801036b0 <myproc>
80106d67:	8b 7d e4             	mov    -0x1c(%ebp),%edi
80106d6a:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106d71:	00 
80106d72:	89 74 24 0c          	mov    %esi,0xc(%esp)
80106d76:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d7d:	00 
80106d7e:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106d82:	8b 40 04             	mov    0x4(%eax),%eax
80106d85:	89 04 24             	mov    %eax,(%esp)
80106d88:	e8 c3 f7 ff ff       	call   80106550 <mappages>
      shm_table.shm_pages[i].refcnt++;
80106d8d:	83 83 fc 54 11 80 01 	addl   $0x1,-0x7feeab04(%ebx)
...
80106dc2:	74 d0                	je     80106d94 <shm_open+0xa4>
    shm_table.shm_pages[first_index].id = id;
80106dc4:	8d 1c 7f             	lea    (%edi,%edi,2),%ebx
80106dc7:	c1 e3 02             	shl    $0x2,%ebx
80106dca:	89 b3 f4 54 11 80    	mov    %esi,-0x7feeab0c(%ebx)
...
80106de5:	83 83 fc 54 11 80 01 	addl   $0x1,-0x7feeab04(%ebx)
    memset(shm_table.shm_pages[first_index].frame, 0, PGSIZE);
80106dec:	89 04 24             	mov    %eax,(%esp)
    shm_table.shm_pages[first_index].frame = kalloc();
80106def:	89 83 f8 54 11 80    	mov    %eax,-0x7feeab08(%ebx)
    memset(shm_table.shm_pages[first_index].frame, 0, PGSIZE);
80106df5:	e8 96 d4 ff ff       	call   80104290 <memset>
    mappages(myproc()->pgdir,(char*)address_v , PGSIZE, V2P(shm_table.shm_pages[first_index].frame) , PTE_W|PTE_U);
80106dfa:	8b 9b f8 54 11 80    	mov    -0x7feeab08(%ebx),%ebx
80106e00:	e8 ab c8 ff ff       	call   801036b0 <myproc>
80106e05:	8b 7d e4             	mov    -0x1c(%ebp),%edi
80106e08:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106e0f:	00 
80106e10:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106e17:	00 
80106e18:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
80106e1e:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106e22:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106e26:	8b 40 04             	mov    0x4(%eax),%eax
80106e29:	89 04 24             	mov    %eax,(%esp)
80106e2c:	e8 1f f7 ff ff       	call   80106550 <mappages>
80106e31:	e9 5e ff ff ff       	jmp    80106d94 <shm_open+0xa4>
...
80106e5b:	eb 21                	jmp    80106e7e <shm_close+0x3e>
80106e5d:	8d 76 00             	lea    0x0(%esi),%esi
80106e60:	8b 50 08             	mov    0x8(%eax),%edx
...
80106e63:	85 d2                	test   %edx,%edx
80106e65:	75 0d                	jne    80106e74 <shm_close+0x34>
      shm_table.shm_pages[i].id = 0;
80106e67:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
      shm_table.shm_pages[i].frame = 0;
80106e6d:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
80106e74:	83 c0 0c             	add    $0xc,%eax
  for (i = 0; i< 64; i++) {
80106e77:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106e7c:	74 12                	je     80106e90 <shm_close+0x50>
    if(shm_table.shm_pages[i].id == id){
80106e7e:	3b 18                	cmp    (%eax),%ebx
80106e80:	75 de                	jne    80106e60 <shm_close+0x20>
      shm_table.shm_pages[i].refcnt--;
80106e82:	8b 48 08             	mov    0x8(%eax),%ecx
80106e85:	8d 51 ff             	lea    -0x1(%ecx),%edx
80106e88:	89 50 08             	mov    %edx,0x8(%eax)
80106e8b:	eb d6                	jmp    80106e63 <shm_close+0x23>
